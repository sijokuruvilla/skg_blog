...
<nav style="display: flex; flex-direction: column; gap: 5px; margin-top: 10px; padding-top: 20px; border-top: 1px solid #eee;">
  <div>
    <a href="https://www.sijokuruvilla.in/calvin-hobbes" style="text-decoration: none; color: #0366d6;">Next: Calvin & Hobbes →</a>
  </div>
  <div>
    <a href="https://www.sijokuruvilla.in/books" style="text-decoration: none; color: #0366d6;">← Previous: Books</a>
  </div>
</nav>