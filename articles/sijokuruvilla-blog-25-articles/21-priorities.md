...
<nav style="display: flex; flex-direction: column; gap: 5px; margin-top: 10px; padding-top: 20px; border-top: 1px solid #eee;">
  <div>
    <a href="https://www.sijokuruvilla.in/import-substitution" style="text-decoration: none; color: #0366d6;">Next: Rethinking import substitution in the knowledge age →</a>
  </div>
  <div>
    <a href="https://www.sijokuruvilla.in/slay" style="text-decoration: none; color: #0366d6;">← Previous: Slaying hoaxes</a>
  </div>
  <div>
