...
[Subscribe: Do provide your information in this form if you wish to be added to my mailing list — Link to form](https://docs.google.com/forms/d/e/1FAIpQLSdvaYokoplPwiCO79OMSJjM38q9s6oQd4MVyJGyAnL3ma-SXA/viewform?usp=sf_link)

<nav style="display: flex; flex-direction: column; gap: 5px; margin-top: 10px; padding-top: 20px; border-top: 1px solid #eee;">
  <div>
    <a href="https://www.sijokuruvilla.in/never" style="text-decoration: none; color: #0366d6;">Next: Never split the difference →</a>
  </div>
  <div>
    <a href="https://www.sijokuruvilla.in/openexam" style="text-decoration: none; color: #0366d6;">← Previous: The open exam experiment</a>
  </div>
</nav>